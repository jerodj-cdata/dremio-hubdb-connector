...
@SourceType(value = "HubDBARP", label = "HubDB",uiConfig = "hubdb-layout.json")
public class HubDBConf extends AbstractArpConf<HubDBConf> {
  private static final String ARP_FILENAME = "arp/implementation/hubdb-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.hubdb.HubDBDriver";
